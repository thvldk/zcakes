            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mt-3 border border-dark" style="background-color: pink;">
                        <div class="card-body">
                            <h1 class="card-title text-center">Build Your Own Cake</h1>
                        </div>
                            <?php
                ...
                <div class="card mt-3 border border-dark" style="background-color: pink;">
                <div class="card-body">
                <img src="images/cake_sizes.jpg" alt="Cake Sizes" style="width: 100%;" />
                ...
                <div class="card mt-3 border border-dark" style="background-color: pink;">
                    <div class="card-body">
                        <h3 class="card-title mb-4">Step 6: Enter Message or Request</h3>
                        <div class="row">
